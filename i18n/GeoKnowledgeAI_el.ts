...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">**Δημιουργία σχεδίου εργασιών:**</translation>
    </message>
    <message>
        <location filename="../orch_manager.py" line="138"/>
        <source>Invalid Task plan!</source>
        <translation>Μη έγκυρο σχέδιο εργασιών!</translation>
    </message>
    <message>
        <location filename="../orch_manager.py" line="143"/>
        <source>VIP requests remaining: </source>
        <translation>Υπόλοιπα αιτήματα VIP: </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η εργασία δεν μπορεί να συνεχιστεί επειδή η μονάδα εκτέλεσης κώδικα δεν είναι διαθέσιμη!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>[Βελτιωμένη] Η υποεργασία [{}] χρειάζεται περαιτέρω προσαρμογή: {}</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Σας ήταν χρήσιμη αυτή η απάντηση; [Ναι](agent://feedback/5) | [Όχι](agent://feedback/1) | [Επανάληψη](agent://repeat)</translation>
    </message>
    <message>
        ...
        <translation type="obsolete">[Εκτέλεση κώδικα](agent://execute/code) | [Αντιγραφή κώδικα](agent://execute/copycode)</translation>
    </message>
    <message>
        ...
        <translation>[Εκτέλεση κώδικα](agent://execute/code/{index}) | [Αντιγραφή κώδικα](agent://execute/copycode/{index})</translation>
    </message>
    <message>
        ...
        <translation type="obsolete">Σας ήταν χρήσιμη αυτή η απάντηση; [Ναι](agent://feedback/5) | [Όχι](agent://feedback/1) | [Επανάληψη](agent://repeat) | [Αλυσίδα σκέψης](agent://cot/1)</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Σφάλμα χρόνου εκτέλεσης</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Ρυθμίσεις Geo Knowledge AI</translation>
    </message>
    <message>
        ...
        <translation>Αιτηθείτε για το κανάλι υψηλής ταχύτητας. Εισαγάγετε τη διεύθυνση email σας και κάντε κλικ στο &quot;Αίτηση&quot;. Θα επικοινωνήσουμε μαζί σας μέσω email εντός 24 ωρών. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Ο προεπιλεγμένος μέγιστος αριθμός γύρων συνομιλίας είναι 2. Οι πολύωρες συνομιλίες μπορεί να προκαλέσουν απώλεια εστίασης στο θέμα.</translation>
    </message>
    <message>
        <location filename="../setting_dialog.ui" line="80"/>
        <source>Turn Limit：</source>
        <translation>Όριο γύρων:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Το προεπιλεγμένο όριο είναι 2 γύροι συνομιλίας για να παραμείνει η συζήτηση στο θέμα.</translation>
    </message>
    <message>
        <location filename="../setting_dialog.ui" line="20"/>
        <source>Chat Mode</source>
        <translation type="obsolete">Λειτουργία συνομιλίας</translation>
    </message>
    <message>
        <location filename="../setting_dialog.ui" line="29"/>
        <source>Geo Knowledge Q&amp;&amp;A</source>
        <translation type="obsolete">Γεωγνώση Ε&amp;&amp;Α</translation>
    </message>
    <message>
        ...
        <translation type="obsolete">Χρησιμοποιήστε συλλογισμό αλυσίδας σκέψης για να δημιουργήσετε, να διορθώσετε και να εκτελέσετε κώδικα.</translation>
    </message>
    <message>
        <location filename="../setting_dialog.ui" line="39"/>
        <source>Generating Code &amp;&amp; Auto-Run</source>
        <translation type="obsolete">Δημιουργία κώδικα &amp;&amp; αυτόματη εκτέλεση</translation>
    </message>
    <message>
        <location filename="../setting_dialog.ui" line="161"/>
        <source>The default limit is 1 conversation turns to help keep the discussion on topic.</source>
        <translation type="obsolete">Το προεπιλεγμένο όριο είναι 1 γύρος συνομιλίας για να παραμείνει η συζήτηση στο θέμα.</translation>
    </message>
    <message>
        <location filename="../setting_dialog.ui" line="39"/>
        <source>Chain-of-Thought Reasoning</source>
        <translation type="obsolete">Συλλογισμός αλυσίδας σκέψης</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το προεπιλεγμένο όριο είναι 3 γύροι συνομιλίας για να παραμείνει η συζήτηση στο θέμα.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Οι προσωρινοί φάκελοι χρησιμοποιούνται για την αποθήκευση ενδιάμεσων αρχείων κατά τη διάρκεια της διαδικασίας λήψης ή ανάλυσης δεδομένων.</translation>
    </message>
    <message>
...
CAUTION: Despite our STRICT restrictions on LLMs, the generated code is not completely reliable. Please check it carefully. We suggest you back up your data and QGIS project before executing code.</source>
        <translation>Για την ενίσχυση της ασφάλειας εκτέλεσης, το QGIS απαγορεύει την αυτόματη εκτέλεση εξωτερικού κώδικα (π.χ. κώδικα που δημιουργείται σε πραγματικό χρόνο από ΜΜ).

Εάν θέλετε να εκτελέσετε κώδικα αυτόματα, πατήστε &quot;Ναι&quot;. Το πρόσθετο Geo Knowledge AI θα κατεβάσει τη μονάδα εκτέλεσης για να ξεκινήσει την αυτοματοποιημένη διαδικασία.

ΠΡΟΣΟΧΗ: Παρά τους ΑΥΣΤΗΡΟΥΣ περιορισμούς μας στα ΜΜ, ο παραγόμενος κώδικας δεν είναι πλήρως αξιόπιστος. Παρακαλούμε ελέγξτε τον προσεκτικά. Σας προτείνουμε να δημιουργήσετε αντίγραφο ασφαλείας των δεδομένων και του έργου QGIS σας πριν εκτελέσετε κώδικα.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αποτυχία υποβολής των σχολίων σας. Παρακαλούμε δοκιμάστε ξανά αργότερα.</translation>
    </message>
    <message>
        ...
        <translation>Σφάλμα δικτύου: ελέγξτε τη σύνδεσή σας και δοκιμάστε ξανά.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Η εκτέλεση κώδικα ξεκίνησε στο παρασκήνιο...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ο κώδικας αντιγράφηκε με επιτυχία!</translation>
    </message>
    <message>
...
### Καλώς ορίσατε στο πρόσθετο Geo Knowledge AI!

**Χαίρομαι που σας γνωρίζω! 🌍**

Είμαι ο βοηθός σας GIS IA, παρέχοντας εξατομικευμένα επαγγελματικά σεμινάρια που καλύπτουν ένα ευρύ φάσμα γεωχωρικών εργασιών, συμπεριλαμβανομένης της ανακάλυψης παγκόσμιων γεωδεδομένων, της γεωεπιστημονικής μοντελοποίησης, της υδρολογικής ανάλυσης και ανάλυσης εδάφους, της επεξεργασίας τηλεπισκόπησης και της δημιουργίας κώδικα PyQGIS.

Επιπλέον, θα σας καθοδηγήσω σε βασικά εργαλεία όπως GDAL, GRASS και SAGA για να κάνω τη χωρική σας ανάλυση πιο αποδοτική και έξυπνη.
 ...
 **🔒 Επιβεβαίωση απορρήτου**

Πριν χρησιμοποιήσετε αυτό το πρόσθετο, διαβάστε και αποδεχτείτε την [Πολιτική απορρήτου](https://github.com/robert6757/qgis-geo-knowledge-ai/blob/main/README.md).

[Έχω διαβάσει και αποδέχομαι την Πολιτική απορρήτου.](agent://privacy/1)</translation>
    </message>
    <message>
...
Σας ευχαριστούμε που επιλέξατε το Geo Knowledge AI! Όλα είναι έτοιμα — ξεκινήστε το ταξίδι σας στο GIS! 🚀</translation>
    </message>
    <message>
        <location filename="../geo_knowledge_ai_dockwidget.py" line="612"/>
        <source>
...
Πριν χρησιμοποιήσετε αυτό το πρόσθετο, διαβάστε την [Πολιτική απορρήτου](https://github.com/robert6757/qgis-geo-knowledge-ai/blob/main/README.md).
...
Εισαγάγετε την ερώτησή σας στο παρακάτω πλαίσιο εισόδου και κάντε κλικ στο κουμπί **Αποστολή** για να ξεκινήσετε τη συνομιλία.

Για να κατανοήσουμε καλύτερα την ερώτησή σας, ενεργοποιήστε τον διακόπτη στιγμιότυπου οθόνης ![Screenshot](qtres://plugins/geo_knowledge_ai/image/screencapture2.svg).

Κατά τη δημιουργία κώδικα, ενεργοποιήστε τον διακόπτη Αλυσίδας σκέψης ![CoT](qtres://plugins/geo_knowledge_ai/image/infinite.svg) για πιο ακριβή απάντηση.

Κάνοντας μια ερώτηση, επιβεβαιώνετε ότι έχετε διαβάσει και αποδεχτεί την [πολιτική απορρήτου](https://github.com/robert6757/qgis-geo-knowledge-ai/blob/main/README.md).
...
Additionally, I will guide you through essential tools like GDAL, GRASS, and SAGA to make your spatial analysis more efficient and intelligent.</source>
        <translation type="obsolete">### Καλώς ορίσατε στο πρόσθετο Geo Knowledge AI!

**Χαίρομαι που σας γνωρίζω! 🌍**

Είμαι ο βοηθός σας GIS IA, παρέχοντας εξατομικευμένα επαγγελματικά σεμινάρια που καλύπτουν τρεις πράκτορες: **πράκτορα Ε&amp;Α γνώσης**, **πράκτορα αναζήτησης δεδομένων** και **πράκτορα δημιουργίας κώδικα**.

 Η βάση γνώσεων μας περιέχει ανακάλυψη παγκόσμιων γεωδεδομένων, γεωεπιστημονική μοντελοποίηση, υδρολογική ανάλυση και ανάλυση εδάφους, επεξεργασία τηλεπισκόπησης και τεκμηρίωση PyQGIS.

Επιπλέον, θα σας καθοδηγήσω σε βασικά εργαλεία όπως GDAL, GRASS και SAGA για να κάνω τη χωρική σας ανάλυση πιο αποδοτική και έξυπνη.</translation>
    </message>
    <message>
...
Είμαι ο βοηθός σας GIS IA, παρέχοντας τρεις πράκτορες: **πράκτορα Ε&amp;Α γνώσης**, **πράκτορα αναζήτησης δεδομένων** και **πράκτορα δημιουργίας κώδικα**.
...
Επιπλέον, θα σας καθοδηγήσω σε βασικά εργαλεία όπως GDAL, GRASS και SAGA για να κάνω τη χωρική σας ανάλυση πιο αποδοτική και έξυπνη.</translation>
    ...
    <message>
        ...
        <translation>Μόνο η τρέχουσα υποεργασία μπορεί να συνεχιστεί.</translation>
    </message>
    <message>
        <location filename="../geo_knowledge_ai_dockwidget.py" line="319"/>
        <source>Only the current subtask can be repeated.</source>
        <translation>Μόνο η τρέχουσα υποεργασία μπορεί να επαναληφθεί.</translation>
    </message>
    <message>
        ...
        <translation>[Βήμα-βήμα](agent://orch/substask/step) | [Αυτοματοποίηση όλων](agent://orch/substask/automate)</translation>
    </message>
    <message>
        ...
        <translation>[Συνέχεια](agent://orch/substask/continue/{subtask_id}) | [Επανάληψη](agent://orch/substask/repeat/{subtask_id}) | [Λεπτομέρεια](agent://orch/substask/detail/{subtask_id})</translation>
    </message>
    <message>
...
Tip: **Workflow Automation** can handle complex tasks either fully automatically or step-by-step. We suggest backing up your data and QGIS projects before running a workflow.</source>
        <translation>### Καλώς ορίσατε στο πρόσθετο Geo Knowledge AI!

**Χαίρομαι που σας γνωρίζω! 🌍**

Είμαι ο βοηθός σας GIS IA, παρέχοντας τέσσερις πράκτορες: **Ε&amp;Α γνώσης**, **Αναζήτηση δεδομένων**, **Δημιουργία κώδικα** και **Αυτοματοποίηση ροής εργασίας**.

 Η βάση γνώσεων μας καλύπτει ανακάλυψη παγκόσμιων γεωδεδομένων, γεωεπιστημονική μοντελοποίηση, υδρολογική ανάλυση και ανάλυση εδάφους, επεξεργασία τηλεπισκόπησης και τεκμηρίωση PyQGIS.

Επιπλέον, μπορώ να σας καθοδηγήσω σε βασικά εργαλεία όπως GDAL, GRASS και SAGA για να κάνω τη χωρική σας ανάλυση πιο αποδοτική και έξυπνη.

Συμβουλή: Η **Αυτοματοποίηση ροής εργασίας** μπορεί να χειριστεί σύνθετες εργασίες είτε πλήρως αυτόματα είτε βήμα-βήμα. Σας προτείνουμε να δημιουργήσετε αντίγραφα ασφαλείας των δεδομένων και των έργων QGIS σας πριν εκτελέσετε μια ροή εργασίας.</translation>
    </message>
    <message>
        <location filename="../code_exec_utils.py" line="98"/>
        <source>Failed to load the downloaded code execution module</source>
        <translation>Αποτυχία φόρτωσης της ληφθείσας μονάδας εκτέλεσης κώδικα</translation>
    </message>
    <message>
        <location filename="../code_exec_utils.py" line="104"/>
        <source>Failed to download code execution module: {}</source>
        <translation>Αποτυχία λήψης της μονάδας εκτέλεσης κώδικα: {}</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>**Σχέδιο εργασιών:**</translation>
    </message>
    <message>
        ...
        <translation>[Συνέχεια](agent://orch/substask/continue/{subtask_id}) | [Βελτίωση](agent://orch/substask/repeat/{subtask_id}) | [Λεπτομέρειες](agent://orch/substask/detail/{subtask_id})</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Η ερώτησή μου:</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Διαγραφή όλου του ιστορικού συνομιλίας</translation>
    </message>
    <message>
        <location filename="../history_dialog.py" line="68"/>
        <source>Are you sure you want to delete all chat history?</source>
        <translation>Είστε σίγουροι ότι θέλετε να διαγράψετε όλο το ιστορικό συνομιλίας;</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Αφαίρεση όλου του ιστορικού</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Λεπτομέρεια υποεργασίας</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="obsolete">Επανάληψη</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το ερώτημα μπορεί να τροποποιηθεί. Κάντε κλικ στο OK μετά την επιβεβαίωση.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Παρακαλούμε εισαγάγετε τη διεύθυνση email σας.</translation>
    </message>
    <message>
        <location filename="../setting_dialog.py" line="97"/>
        <source>Please enter a valid email address.</source>
        <translation>Παρακαλούμε εισαγάγετε μια έγκυρη διεύθυνση email.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το αίτημά σας ελήφθη. Θα επικοινωνήσουμε μαζί σας μέσω email εντός 24 ωρών. Ελέγξτε τα εισερχόμενά σας αργότερα.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αποτυχία υποβολής του αιτήματός σας. Παρακαλούμε δοκιμάστε ξανά αργότερα.</translation>
    </message>
    <message>
        <location filename="../setting_dialog.py" line="124"/>
        <source>Network error. Please check your connection and try again.</source>
    ...
    <message>
        ...
        <translation>Επιλογή Προσωρινού Φακέλου</translation>
    </message>
</context>
<context>
